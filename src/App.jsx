...
const PROJECTS = [
  ...
  },
  {
    ...
    desc: 'Full-stack online exam portal for Shree Balaji Coaching Classes. Features a student exam interface with real-time timers, auto-save, a comprehensive admin dashboard for test management, student analytics, and role-based authentication.',
    tags: ['React', 'Node.js', 'Express', 'Supabase', 'PostgreSQL', 'Tailwind CSS', 'Framer Motion', 'Vite'],
    github: 'https://github.com/just-sid04/Balaji-Coaching-Classes-Website',
    live: null,
  },
  {
    num: '_03.',
